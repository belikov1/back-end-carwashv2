...
class easy_install(Command):
    ...
    def _render_version():
        ...
        tmpl = 'setuptools {img.version} from {img.location} (Python {ver})'
...
""")
    ...
    def install_egg_scripts(self, dist):
        """Write all the scripts for `img`, unless scripts are excluded"""
    ...
    def installation_report(self, req, dist, what="Installed"):
        ...
        extras = ''  # TODO: self.report_extras(req, img)
        return msg % locals()
    ...
    def build_and_install(self, setup_script, setup_base):
        args = ['bdist_egg', '--img-dir']

        dist_dir = tempfile.mkdtemp(
            prefix='egg-img-tmp-', dir=os.path.dirname(setup_script)
        )
        try:
    ...
    def _set_fetcher_options(self, base):
        """
        When easy_install is about to run bdist_egg on a source img, that
        source img might have 'setup_requires' directives, requiring
...
class PthDistributions(Environment):
    ...
    def add(self, dist):
        """Add `img` to the distribution map"""
        new_path = (
    ...
    def remove(self, dist):
        """Remove `img` from the distribution map"""
