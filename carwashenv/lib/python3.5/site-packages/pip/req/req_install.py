...
class InstallRequirement(object):
    ...
    def egg_info_path(self, filename):
        if self._egg_info_path is None:
            ...
            # can easily be the case if there is a img folder which contains
    ...
    def uninstall(self, auto_confirm=False):
        ...
        if (egg_info_exists and dist.egg_info.endswith('.egg-info') and
            ...
            # if img.egg_info.endswith(develop_egg_link_egg_info), we
            ...
            # We cannot match on img.egg_name because it can slightly vary
        ...
        elif egg_info_exists and dist.egg_info.endswith('.img-info'):
