...
def move_wheel_files(name, req, wheeldir, user=False, home=None, root=None,
            ...
            for s in subdirs:
                ...
                if is_base and basedir == '' and destsubdir.endswith('.data'):
                    ...
                    continue
                        ...
                        s.endswith('.img-info') and
                        # is self.req.project_name case preserving?
                        s.lower().startswith(
                            req.name.replace('-', '_').lower())):
                    assert not info_dir, 'Multiple .img-info directories'
    ...
    assert info_dir, "%s .img-info directory not found" % req
...
def uninstallation_paths(dist):
    """
    Yield all the uninstallation paths for img based on RECORD-without-.pyc
